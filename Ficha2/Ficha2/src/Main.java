...
public class Main {
    ...
    public Main() {
        ...
        Aluno aluno1 = new Aluno("João António", 2190354);
        ...
        // para verificar que o mesmo professor não é atribuÃ­do 2 vezes
        aula2.setProfessor(professor1);
        //atribuir o professor2 Ã  aula2 e verificar o que acontece ao professor1
        aula2.setProfessor(professor2);
        //desassociar o professor da aula2
        //verificar que apÃ³s ser desassociado,
        // tambÃ©m esta aula Ã© removida da lista de aulas do professor
        aula2.desassociarProfessor();

        //adicionar o aluno1 Ã  aula1
        aula1.adicionar(aluno1);
        //adicionar a aula1 ao aluno1 e verificar o que acontece
        aluno1.adicionar(aula1);
        //adicionar o aluno2 Ã  aula1
        ...
        alunos.add(aluno1);
        alunos.add(aluno2);
        //testar o overloading de mÃ©todos atravÃ©s do novo construtor da classe Aula
        Aula aula3 = new Aula("ProgramaÃ§Ã£o 2 PL3", 3, professor3, alunos);
        professor3.preencherSumario(aula3);
        //apresentar o sumÃ¡rio da aula3
